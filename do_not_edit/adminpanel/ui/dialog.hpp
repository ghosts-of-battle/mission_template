...
class GHOST_AdminPanel
{
	...
	class controls
	{
		...
		class REMOTEEXEC_LOCALEXEC_PREV: RscADMPButton
		{
			...
			onLoad = "_this#0 ctrlSetText getMissionPath 'do_not_edit\adminpanel\ui\icons\arrow_left.paa';";
		...
		class REMOTEEXEC_LOCALEXEC_NEXT: RscADMPButton
		{
			...
			onLoad = "_this#0 ctrlSetText getMissionPath 'do_not_edit\adminpanel\ui\icons\arrow_right.paa';";
