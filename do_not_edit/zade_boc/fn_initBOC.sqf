...
_action = ["zade_boc_onChest", "Put backpack on chest", "do_not_edit\zade_boc\data\actions\onchest_ca.paa",
...
_action = ["zade_boc_onBack", "Put backpack on back", "do_not_edit\zade_boc\data\actions\onback_ca.paa",
...
_action = ["zade_boc_swap", "Swap backpacks", "do_not_edit\zade_boc\data\actions\swap_ca.paa",
